...
const ETF_MAP = {
  goldilocks: {
    ...
    long:  ['QQQ','IWF','SMH','AIQ','CIBR','XLK','XLY','XLC','IWM','IJH','HYG','CWB',
            'SPMO','KWEB','FXI','CHIQ','EEM','SPY','XRT','XHB','IBIT','PAVE','ITA',
  ...
  boom: {
    ...
    long:  ['XLE','XLB','XLI','XLF','GLD','SLV','CPER','DBC','DBA','USO','XTN','PAVE',
            'KRE','KIE','ITA','EEM','EWW','EZA','DXJ','IWD','IWM','CEW','EMX','VNM',
  ...
  stagflation: {
    ...
    short: ['QQQ','IWF','IWM','SPY','XLY','XLC','HYG','CWB','EEM','KWEB','FXI','CHIQ',
  ...
  bust: {
    ...
    long:  ['TLT','IEF','IEI','SHY','GLD','XLU','XLP','XLV','SPLV','SDY','MUB','FXY',
            'EMB','XHE','KMOAT','IWD'],
    short: ['XLE','XLB','XLI','USO','DBC','DBA','HYG','CWB','IWM','EEM','XLY','XRT',
